...
public class Colors : MonoBehaviour {
    ...
    // appli で使用中
	public static Color titleback = rgb(5,86,20);
//	public static Color titleText = rgb(255,255,255);
    public static Color male = rgb(213, 224, 241);
    public static Color female = rgb(249,222,225);
	public static Color maleDisable = rgb(170,200,200);
	public static Color femaleDisable = rgb(220,200,200);
	public static Color btnFunctionBack = rgb(50,120,50);
	public static Color btnFunctionText = rgb(255,255,255);
	public static Color btnCancelBack = rgb(0,0,0);
	public static Color btnCancelText = rgb(255,255,255);
	public static Color unLockCourt = rgb(180,238,181);
	public static Color lockCourt= rgb(250,200,80);
//	public static Color playCourt= rgb(50,120,50);
	public static Color playCourt= rgb(94,183,90);
